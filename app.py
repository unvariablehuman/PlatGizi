    ...
    with col1:
        ...
        with c2:
            ...
            <div class="info-card">
                ...
                <b style="color:#1a6b3c;">15641</b> resep dari 8 kategori bahan utama</div>
            </div>
            """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        if model_loaded:
            ...
            <div style="margin-top:4px; text-align:right;">
                <a href="https://github.com/unvariablehuman/PlatGizi/blob/main/Permenkes-No-28-Tahun-2019-Angka-Kecukupan-Gizi-yang-Dianjurkan.pdf" target="_blank" style="font-size:0.75rem; color:#2d9e5f; text-decoration:none; font-weight:600;">Lihat Sumber Data (PDF)</a>
            </div>
            """, unsafe_allow_html=True)
    ...
    if st.session_state.get("run_preprocessing", False):
        ...
        with tab_raw:
            if csv_loaded:
                ...
                with t1:
                    st.dataframe(nutrition_raw, use_container_width=True)
                with t2:
        ...
        with tab_clean:
            if csv_loaded:
                ...
                with t1:
                    st.dataframe(nutrition_clean, use_container_width=True)
                with t2:
                    ...
                    st.dataframe(nutrition_clean[cols_scaled], use_container_width=True)
                with t3:
        ...
        with tab_raw2:
            if csv_loaded:
                ...
                with t1:
                    st.dataframe(resep_raw, use_container_width=True)
                with t2:
        ...
        with tab_clean2:
            if csv_loaded:
                ...
                t1, t2, t3 = st.tabs(["Data Preview", "Data Null", "Per Kategori"])
                with t1:
                    st.dataframe(resep_clean, use_container_width=True)
                with t2:
